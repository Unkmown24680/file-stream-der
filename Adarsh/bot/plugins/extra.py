    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="ɪ  ᴀᴍ  ᴍᴀɪɴᴛᴀɪɴᴇᴅ  ʙʏ  Unknown😈 [Unknown](https://telegram.me/SM_contactadmin_bot)",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("Amazing Deals⚡🔥😱", url=f"https://telegram.me/hotflashdealss")
                            ],
                             [
